...
export function ProjectClient({
  ...
  const boundInvite = inviteMember.bind(null, projectId);
  ...
  const canUpload = role === "admin" || role === "architect";
  ...
  const statusLabel = (status: string) =>
    t(
      `documents.statuses.${status as "draft" | "in_review" | "approved" | "changes_requested" | "submitted"}`,
    ) ?? status;
